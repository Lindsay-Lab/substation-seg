...
checkpoint_path = 'models/cropped_sentinel_resnet18_augmentation_focal_75/end.pth'  # Replace with your file path
    ...
    with torch.no_grad():
        ...
        for batch in val_dataloader:
            ...
            for pred, true in zip(pred_mask, target):
                ...
                true = torch.squeeze(true, dim=0)[2:-2,2:-2]
